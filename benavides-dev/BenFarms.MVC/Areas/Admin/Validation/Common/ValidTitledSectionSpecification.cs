...
{
    public class ValidTitledSectionSpecification : Specification<WhoWeAreTitledSection>
    {
        private readonly IEnumerable<string> files;
        private readonly bool ignoreMissingFile;

        public ValidTitledSectionSpecification(IEnumerable<string> uploadedFiles, bool ignoreMissingFile)
        {
