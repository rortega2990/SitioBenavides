...
(function dFlip(DFLIP, $) {
	...
	var defaults = DFLIP.defaults = {
		...
		pdfjsSrc: GetBase() + "dflip/js/libs/pdf.min.js",
		//pdfjsSrc: "http://localhost:44638/dflip/js/libs/pdf.min.js",
		//(NON-OPTION) source link for PDFcompatibility.JS file
		pdfjsCompatibilitySrc: GetBase() + "dflip/js/libs/compatibility.js",
		//pdfjsCompatibilitySrc: "http://localhost:44638/dflip/js/libs/compatibility.js",
		//(NON-OPTION) source link for PDF.WORKER.JS file
	    pdfjsWorkerSrc: GetBase() + "dflip/js/libs/pdf.worker.min.js",
		//pdfjsWorkerSrc: "http://localhost:44638/dflip/js/libs/pdf.worker.min.js",
		//(NON-OPTION) source link for THREE.JS file
		threejsSrc: GetBase() + "dflip/js/libs/three.min.js",
		//threejsSrc: "http://localhost:44638/dflip/js/libs/three.min.js",
		//(NON-OPTION) source link for MOCKUP.JS file
		mockupjsSrc: GetBase() + "dflip/js/libs/mockup.min.js",
		//(NON-OPTION) File path to the trun sound
		soundFile: GetBase() + "dflip/sound/turn2.mp3",
